<div class="container">
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="space-y-2">
          <input type="text" name="" wire:model="searchString" id="">
              ...
              <ul class="space-y-1 border-t border-gray-200 p-4">
                <li>
                  <label for="FilterInStock" class="inline-flex items-center gap-2">
                    <input type="radio" name="availability" id="FilterInStock" class="h-5 w-5 rounded border-gray-300" />
                ...
                <li>
                  <label for="FilterOutOfStock" class="inline-flex items-center gap-2">
                    <input type="radio" name="availability" id="FilterOutOfStock"  class="h-5 w-5 rounded border-gray-300" />
                    <span class="text-sm font-medium text-gray-700">
            ...
            <div class="col-md-4">
              <div class="group relative block overflow-hidden text-decoration-none text-dark drop-shadow-lg py-2">
                ...
                <div class="relative bg-white p-6">
                  <span class="whitespace-nowrap px-3 py-1.5 text-xs font-medium {{$product->quantity > 0 ? 'bg-yellow-400' : 'bg-red-500 text-white' }}">
